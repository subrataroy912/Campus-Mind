    ...
    <div className="min-h-screen bg-slate-50 py-6 px-4 sm:py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-md">
        ...
        <div className="mb-6 text-center sm:mb-8">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-100 sm:h-14 sm:w-14">
            <svg
        ...
        <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-6 lg:p-8">
          {status !== "joined" && (
            <form onSubmit={handleFindClass}>
                ...
                {code.map((char, i) => (
                  <div key={i} className="flex items-center">
                    <input
                      ...
                      onPaste={handlePaste}
                      className="h-11 w-9 rounded-lg border border-slate-300 text-center text-lg font-semibold uppercase text-slate-900 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 sm:h-12 sm:w-11 sm:text-xl"
                    />
                    {i === 3 && (
                      <span className="mx-1 text-slate-300 sm:mx-1.5">–</span>
                    )}
                  </div>
                ))}
              </div>
              ...
              <button
                ...
                className="mt-5 w-full rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
