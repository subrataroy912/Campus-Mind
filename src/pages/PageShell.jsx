...
function PageShell({ title, eyebrow, description, actions = [], children }) {
  ...
  return (
    <main className="min-h-dvh bg-canvas px-4 py-6 text-text-heading sm:px-8 sm:py-10 lg:px-10">
      <section className="mx-auto w-full max-w-6xl space-y-6">
        <article className="rounded-xl border border-border bg-surface p-5 shadow-sm sm:p-10">
