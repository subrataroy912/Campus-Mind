...
import { Bell, CalendarDays, ChevronRight, ClipboardList, Code2, FlaskConical, GraduationCap, Home, LogOut, Mail, Settings, User, Users } from 'lucide-react'
...
const classes = [{ name: 'Mathematics', section: 'Section A • Mr. Thompson', students: 28, progress: 75, icon: ClipboardList, color: 'blue' }, { name: 'Physics', section: 'Section B • Dr. Patel', students: 31, progress: 60, icon: FlaskConical, color: 'purple' }, { name: 'Computer Science', section: 'Section C • Prof. Lee', students: 26, progress: 90, icon: Code2, color: 'teal' }]
const assignments = [{ title: 'Calculus Problem Set', className: 'Mathematics • Section A', tag: 'Mathematics', due: 'Due in 2 Hours', icon: ClipboardList, color: 'blue', dueColor: 'red' }, { title: "Lab Report: Newton's Laws", className: 'Physics • Section B', tag: 'Physics', due: 'Due Tomorrow', icon: FlaskConical, color: 'purple', dueColor: 'orange' }, { title: 'Python Programming Project', className: 'Computer Science • Section C', tag: 'Computer Science', due: 'Due in 3 days', icon: Code2, color: 'teal', dueColor: 'green' }]
