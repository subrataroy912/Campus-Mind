          ...
          <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
              ...
              <div className="space-y-1">
                ...
                {isCustomSubject && (
                  <Input
                    ...
                    className="w-full rounded-lg border border-border bg-canvas px-2.5 py-1.5 text-xs text-text-main mt-1"
                  />
                )}
              </div>
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                rows={2}
                className="w-full rounded-lg border border-border bg-canvas px-2.5 py-1.5 text-xs text-text-main resize-none"
