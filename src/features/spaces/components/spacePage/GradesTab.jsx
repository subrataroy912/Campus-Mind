...
export function GradesTab({
  ...
  const {
    studentRows = [],
    isLoading: isLoadingStudentGrades = false,
    error: studentGradesError = null,
  ...
  const {
    gradebookRows = [],
    isLoading: isLoadingCourseGrades = false,
    error: courseGradesError = null,
  ...
  const gradesError = isStaff ? courseGradesError : studentGradesError;
  const refetchGrades = isStaff ? refetchCourseGrades : refetchStudentGrades;
  ...
  return (
    <section className="mt-3 space-y-3">
      ...
      <AsyncStateBoundary
        ...
        error={gradesError}
        errorTitle="Unable to load gradebook"
        onRetry={refetchGrades}
        loadingFallback="table"
        isEmpty={rows.length === 0}
        emptyTitle="No grades available yet"
        emptyDescription="Grades will appear here as coursework is completed and reviewed."
      >
