      ...
      <div className="space-y-3">
        ...
        {!isEnrolled && accessType === "PRIVATE" ? (
          ...
          <AsyncStateBoundary
            ...
            error={courseworkError}
            errorTitle="Could not load space updates"
            onRetry={refetchCoursework}
            loadingFallback="feed"
            isEmpty={announcements.length === 0}
            emptyTitle="No updates posted yet"
            emptyDescription="Announcements, project updates, and discussions will appear here when posted."
          >
