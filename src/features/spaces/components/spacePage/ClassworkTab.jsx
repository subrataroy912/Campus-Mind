    ...
    <div className="mt-3 grid grid-cols-1 gap-3.5 lg:grid-cols-[1fr_260px]">
      <main className="space-y-3.5">
        ...
        <AsyncStateBoundary
          ...
          error={error}
          errorTitle="Unable to load classwork at the moment"
          onRetry={refetch}
          loadingFallback="coursework"
          isEmpty={items.length === 0}
          emptyTitle="No classwork posted yet"
          emptyDescription="Assignments and learning materials will appear here when assigned."
          emptyAction={
            isStaff
              ? {
