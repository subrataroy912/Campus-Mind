...
export function MembersTab({
  ...
  const {
    roster = [],
    isLoading: isLoadingRoster = false,
    ...
    <section className="mt-3 space-y-3">
      ...
      <div className="rounded-xl bg-card p-3.5 sm:p-4 border border-border/70 shadow-2xs space-y-4">
        ...
        <AsyncStateBoundary
          ...
          error={rosterError}
          errorTitle="Could not load space members"
          onRetry={refetchRoster}
          loadingFallback="members"
          isEmpty={members.length === 0}
          emptyTitle="No members found"
          emptyDescription="Try searching with a different name or spelling."
        >
