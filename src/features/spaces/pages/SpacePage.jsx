...
import SpaceQuickLinks from "../components/SpaceQuickLinks.jsx";
import { SpacePageSkeleton } from "../components/SpacePageSkeleton.jsx";
...
import {
  ...
  GradesTab,
  MembersTab,
} from "../components/spacePage/index.js";
...
export default function SpacePage() {
  ...
  const isNotFound =
    !classroom && (!error || error?.status === 404 || error?.data?.status === 404);
